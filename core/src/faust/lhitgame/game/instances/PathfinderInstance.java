...
public abstract class PathfinderInstance extends AnimatedInstance {
    ...
    public void calculateNewGoal(RoomNodesGraph roomNodesGraph) {
        ...
        if (Objects.isNull(roomNodesGraph) || canSeePlayer() || !recalculatePath)
            return;
        ...
        PathNode currentPos = nodeArray.get(0);
        ...
        PathNode newGoal = nodeArray.get(0);
